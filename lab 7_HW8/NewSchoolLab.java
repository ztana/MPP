...
class Faculty extends Person
{
	...
	public void myDefault() {
		// TODO Auto-generated method stub
		System.out.println("My default function. from faculty.");
	}
}
...
class Student extends Person
{
	...
	public void myDefault() {
		// TODO Auto-generated method stub
		System.out.println("My defult function. from student.");
	}
}
...
class Staff extends Person
{
	...
	public void myDefault() {
		// TODO Auto-generated method stub
		System.out.println("my default function. from staff");
	}	
}
...
class EDepartment
{
	...
	public EDepartment(String name) {
		Name = name;
...
public class NewSchoolLab
   {
   public static void main(String[] args) throws IOException
      {
      EDepartment dept = new EDepartment("ComputerScience");
   ...
   private static Collection findStudentByCourse(Course c) {
	   ...
	   for(Person p:EDepartment.persons)
	   {
		   if(p instanceof Student)
		   {
